...
class install
{
	...
	function step_1()
	{
		...
		if(isset($_POST['step_1'])) {
			...
			echo '<div class="input-field col s6">
			<input id="user" type="text" name="user" value="root" >
			...
			echo '<div class="input-field col s6">
			<input id="database_name" type="text" name="database_name" value="test" required>
	...
	{
		$this->save_config();
		echo "<span class='pass'> install successfully </span><br />";
		echo "default username: <b>admin</b><br />";
