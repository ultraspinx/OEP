	...
	<div class="navbar-fixed">
		<nav>
			<div class="nav-wrapper nav-green">
				<div class="left pad-left-20"><a class="cursor" id="trigger-sidebar"><i class="material-icons" id="menu-icon" title="Show/hide directory board">menu</i></a></div>
	...
	<div class="sidebar-left sidebar-show menu-sidebar scrollbar" id="sidebar-left">
		...
		<ul class="collapsible reset-margin" data-collapsible="accordion">
			<li class="active">
				<div class="collapsible-header" id="menu"><i class="material-icons hide" id="menu-arrow-down">arrow_drop_down</i>
					<i class="material-icons" id="menu-arrow-up">arrow_drop_up</i>Class list</div>
					<div class="collapsible-body list" id="list_classes_sidebar">
					</div>
				</li>
				<a href="index.php?action=list_test" class="collapsible-header font-color cursor"><i class="material-icons">list</i>See mark list</a>
				<a href="index.php?action=show_notifications" class="collapsible-header font-color cursor"><i class="material-icons">send</i>Show notification</a>
				<a href="index.php?action=show_about" class="collapsible-header font-color cursor"><i class="material-icons">insert_comment</i>How about</a>
			</ul>
		</div>
		<a data-target="modal1" class="sidebar-show logout modal-trigger waves-effect" id="logout">Log out</a>
		<div id="modal1" class="modal">
			...
			<div class="modal-footer">
				...
				<a class="modal-action modal-close waves-effect waves-green btn-flat" id="btn-logout">Yes</a>
			</div>
		</div>
